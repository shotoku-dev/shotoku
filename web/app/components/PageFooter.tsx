export default function PageFooter() {
  return (
    <footer className="px-6 sm:px-16 lg:px-64 pt-10 pb-8 flex flex-col gap-8" style={{ fontFamily: "Satoshi, sans-serif" }}>
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
        <span className="text-xs text-[rgba(0,0,0,0.4)] flex items-center gap-2 sm:flex-1">
        ...
        <div className="flex items-center justify-between sm:flex-1 sm:justify-center">
          <div className="flex items-center gap-4 text-xs text-[rgba(0,0,0,0.35)]">
          ...
          <span className="text-xs text-[rgba(0,0,0,0.4)] sm:hidden">© Shotoku 2026</span>
        </div>
        <span className="hidden sm:block text-xs text-[rgba(0,0,0,0.4)] sm:flex-1 sm:text-right">© Shotoku 2026</span>
      </div>
    </footer>
  );
}
