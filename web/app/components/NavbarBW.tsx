...
export default function NavbarBW() {
  ...
  return (
    <header className="fixed top-5 left-1/2 -translate-x-1/2 z-100 flex items-center gap-5 py-0 pl-0 pr-2 bg-black rounded-[18px] whitespace-nowrap overflow-hidden">
      <Image
        src="/assets/brand/shotoku-logo-rounded-bw.svg"
        alt="Shotoku"
        width={52}
        height={52}
      />
      ...
      <a
        href="#install"
        className="ml-auto px-3 py-2 text-[13px] font-medium flex items-center gap-1.5 rounded-[10px] transition-[background-color,scale] duration-150 ease-out active:scale-[0.96]"
        style={{ background: "#E8E8E8", color: "#110404" }}
