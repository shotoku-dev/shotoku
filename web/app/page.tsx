  ...
  return (
    <>
      ...
      <main className="pt-[52px]">
        ...
        <section className="px-64 pt-8 pb-20 flex flex-col gap-4">
          <p className="text-[1.5rem] font-medium tracking-tight leading-[1.2] text-[#0A0A0A]" style={{ fontFamily: "Satoshi, sans-serif" }}>
